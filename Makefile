...
datafiles = absolutepath-help.pd basedir-help.pd char2f-help.pd comma-help.pd dinlet~-help.pd dispatch-help.pd dripchar-help.pd f2char-help.pd f2s-help.pd gamme-help.pd image-help.pd makecolor-help.pd mknob-help.pd moonlib-meta.pd panvol~-help.pd popen-help.pd readsfv~-help.pd relativepath-help.pd s2f-help.pd sarray-help.pd sfread2~-help.pd slist-help.pd ssaw~-help.pd tabdump2-help.pd tabenv-help.pd tabreadl-help.pd tabsort2-help.pd tabsort-help.pd wac-help.pd LICENSE.txt README.txt \
